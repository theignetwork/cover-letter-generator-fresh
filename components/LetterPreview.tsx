    ...
    <div className="space-y-4">
          ...
          <div className="relative">
            {isEditing ? (
              <div className="p-4">
                <textarea
                  ref={textareaRef}
                  className="w-full min-h-[400px] max-h-[600px] bg-transparent focus:outline-none resize-none text-sm leading-relaxed overflow-y-auto"
      ...
      {letterContent && (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                ...
                {keywords.length > 12 && (
                  <p className="text-xs text-muted-foreground">
                    Showing top 12 keywords. {keywords.length - 12} more analyzed.
                  </p>
                )}
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-center">
                <div className={`relative w-32 h-32 ${impactScore >= 85 ? 'drop-shadow-[0_0_15px_rgba(20,184,166,0.4)]' : ''}`}>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <span className={`text-3xl font-bold ${impactScore >= 85 ? 'text-teal-400' : 'text-foreground'}`}>
                        {impactScore}
                      </span>
                      <span className={`text-lg ${impactScore >= 85 ? 'text-teal-400' : 'text-foreground'}`}>%</span>
          ...
          {/* Pro Tip */}
          <div className="bg-gradient-to-r from-primary/10 to-accent/10 border border-primary/20 rounded-md p-4 mt-6">
            <div className="flex items-start space-x-3">
              <div className="flex-shrink-0">
